...
Page({
  ...
  loadFontFace() {
    wx.loadFontFace({
      family: '106',
      source: 'url("https://cdns.qdu.life/font/eatwhat@v1.ttf")',
      success: (res) => {
  ...
  like_food:function(){
    this.setData({like_food:!this.data.like_food})
  },
  ...
  //  停止
  stopSelect:function(){
    this.setData({selectStartStatus:false})
    console.log("暂停")
