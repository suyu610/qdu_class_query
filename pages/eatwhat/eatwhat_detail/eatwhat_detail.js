...
Page({
  ...
  handleInsertSuccess:function(data){
    this.setData({newInputCommentValue:"",commentList:[]})
  ...
  insertComment:function(){
    var params = {"foodId":this.data.food.id,"content":this.data.newInputCommentValue};
  ...
  onLoad: function (options) {
    this.setData({food:app.globalData.selectFood})
